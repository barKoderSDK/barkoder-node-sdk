...
typedef enum {
    ...
    BKGlobalOption_LazyInitEnable, /**< Set first init non blocking in background. */
    BKGlobalOption_RestultLocationPreview, /**< Return result with empty text and location(s) even if item is not decoded. */
    BKGlobalOption_DisableGPUCompletely /**< Completely disable GPU for ML and OCR tasks */
...
public:
    ...
    int enableComposite = 0; /**< Enable Composite barcodes detection. */
    ...
    Databar14Config databar14;
    DatabarLimitedConfig databarLimited;
    DatabarExpandedConfig databarExpanded;
    PostalIMBConfig postalIMB;
    PostnetConfig postnet;
    PlanetConfig planet;
    AustralianPostConfig australianPost;
    RoyalMailConfig royalMail;
    JapanesePostConfig japanesePost;
    KIXConfig kix;
    
    IDDocumentConfig idDocument;
     ...
     */
    const NSBarkoder::Rect& RegionOfInterest();
...
private:
    ...
    int handle;
    NSBarkoder::Rect regionOfInterest;
