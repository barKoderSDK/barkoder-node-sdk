...
typedef enum {
    ...
    BKPostalIMB,              /**< Postal IMB barcode. */
    BKPostnet,                /**< Postnet barcode. */
    BKPlanet,                 /**< Planet barcode. */
    BKAustralianPost,         /**< Australian Post barcode. */
    BKRoyalMail,              /**< Royal Mail barcode. */
    BKKIX,                    /**< PostNL KIX barcode. */
    BKJapanesePost,           /**< Japanese post code. */
    BKMaxiCode                /**< MaxiCode barcode. */
...
inline std::string SymbologyToString(BKSymbology symbology)
{
    switch (symbology)
    {
        ...
        case BKMaxiCode: return "BKMaxiCode";
        ...
        case BKPostalIMB: return "BKPostalIMB";
        case BKPostnet: return "BKPostnet";
        case BKPlanet: return "BKPlanet";
        case BKAustralianPost: return "BKAustralianPost";
        case BKRoyalMail: return "BKRoyalMail";
        case BKJapanesePost: return "BKJapanesePost";
        case BKKIX: return "BKKIX";
